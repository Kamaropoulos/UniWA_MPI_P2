...
\DoxyCodeLine{00050 }
\DoxyCodeLine{00051     localData = \mbox{\hyperlink{networking_8cpp_a3a44c57f314e8ae5a1c782ba82cfd8ad}{scatterData}}(data, arraySize, myRank, processes);}
\DoxyCodeLine{00052 }
...
\DoxyCodeLine{00066     \mbox{\hyperlink{networking_8cpp_aeb4e88c5e00d6166f5f35a59671f3667}{calculateB}}(localData, arraySize, max, myRank, processes, \&minLocal, \&minXLocal, \&minYLocal);}
\DoxyCodeLine{00067 }
\DoxyCodeLine{00068     \textcolor{keywordtype}{int} min, minX, minY;}
\DoxyCodeLine{00069     \mbox{\hyperlink{networking_8cpp_ad3bc02c1c672b6ae601f31c897f7af2f}{findMin}}(minLocal, minXLocal, minYLocal, \&min, \&minX, \&minY, myRank);}
\DoxyCodeLine{00070 }
