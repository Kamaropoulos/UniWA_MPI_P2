...
\DoxyCodeLine{00017 }
\DoxyCodeLine{00018 TEST\_CASE(\textcolor{stringliteral}{"Convert a vector<vector<int> object to int**"}, \textcolor{stringliteral}{"[vector2DToArray2D]"})}
\DoxyCodeLine{00019 \{}
...
\DoxyCodeLine{00046 \}}
\DoxyCodeLine{00047 }
\DoxyCodeLine{00048 TEST\_CASE(\textcolor{stringliteral}{"Convert 2D array to 1D Row-Major"}, \textcolor{stringliteral}{"[array2DTo1DRowMajor]"})}
\DoxyCodeLine{00049 \{}
...
\DoxyCodeLine{00059     \}}
\DoxyCodeLine{00060 }
\DoxyCodeLine{00061     \textcolor{keywordtype}{int} *result = array2DTo1DRowMajor(array, 4, 4);}
\DoxyCodeLine{00062 }
...
\DoxyCodeLine{00075 \}}
\DoxyCodeLine{00076 }
\DoxyCodeLine{00077 TEST\_CASE(\textcolor{stringliteral}{"Prepare Data for Gathering: 1x4"}, \textcolor{stringliteral}{"[prepareData]"})}
\DoxyCodeLine{00078 \{}
...
\DoxyCodeLine{00085     prepareData(vec, arr);}
\DoxyCodeLine{00086 }
...
\DoxyCodeLine{00091 \}}
\DoxyCodeLine{00092 }
\DoxyCodeLine{00093 TEST\_CASE(\textcolor{stringliteral}{"Convert 2D Array to 1D Array in Row-Major Order"}, \textcolor{stringliteral}{"[array2DTo1DRowMajor]"})}
\DoxyCodeLine{00094 \{}
...
\DoxyCodeLine{00102 }
\DoxyCodeLine{00103     \textcolor{keywordtype}{int} *arr1D = array2DTo1DRowMajor(arr2D, 1, 4);}
\DoxyCodeLine{00104 }
...
\DoxyCodeLine{00109 \}}
\DoxyCodeLine{00110 }
\DoxyCodeLine{00111 TEST\_CASE(\textcolor{stringliteral}{"Prepare Data for Gathering: 2x4"}, \textcolor{stringliteral}{"[prepareData]"})}
\DoxyCodeLine{00112 \{}
...
\DoxyCodeLine{00121     prepareData(vec, arr);}
\DoxyCodeLine{00122 }
...
\DoxyCodeLine{00131 \}}
\DoxyCodeLine{00132 }
\DoxyCodeLine{00133 TEST\_CASE(\textcolor{stringliteral}{"Check criteria for local data: true"}, \textcolor{stringliteral}{"[checkCriteriaLocal]"})}
\DoxyCodeLine{00134 \{}
...
\DoxyCodeLine{00148 }
\DoxyCodeLine{00149     \textcolor{keywordtype}{bool} resultLocal = checkCriteriaLocal(localData, arraySize, 0, 1, \&maxLocal);}
\DoxyCodeLine{00150 }
\DoxyCodeLine{00151     CHECK(resultLocal == \textcolor{keyword}{true});}
\DoxyCodeLine{00152     CHECK(maxLocal == 46);}
\DoxyCodeLine{00153 \}}
\DoxyCodeLine{00154 }
\DoxyCodeLine{00155 TEST\_CASE(\textcolor{stringliteral}{"Check criteria for local data: false"}, \textcolor{stringliteral}{"[checkCriteriaLocal]"})}
\DoxyCodeLine{00156 \{}
...
\DoxyCodeLine{00170 }
\DoxyCodeLine{00171     \textcolor{keywordtype}{bool} resultLocal = checkCriteriaLocal(localData, arraySize, 0, 1, \&maxLocal);}
\DoxyCodeLine{00172 }
\DoxyCodeLine{00173     CHECK(resultLocal == \textcolor{keyword}{false});}
\DoxyCodeLine{00174     CHECK(maxLocal == 38);}
\DoxyCodeLine{00175 \}}
\DoxyCodeLine{00176 }
\DoxyCodeLine{00177 TEST\_CASE(\textcolor{stringliteral}{"Calculate Local B Lines: Process 0, 4 Lines, 4 Processes"}, \textcolor{stringliteral}{"[calculateBLocal]"})}
\DoxyCodeLine{00178 \{}
...
\DoxyCodeLine{00186 }
\DoxyCodeLine{00187     std::vector<std::vector<int>> localB = calculateBLocal(localData, max, arraySize, myRank, processes, \&min, \&minX, \&minY);}
\DoxyCodeLine{00188 }
...
\DoxyCodeLine{00202 \}}
\DoxyCodeLine{00203 }
\DoxyCodeLine{00204 TEST\_CASE(\textcolor{stringliteral}{"Calculate Local B Lines: Process 1, 4 Lines, 4 Processes"}, \textcolor{stringliteral}{"[calculateBLocal]"})}
\DoxyCodeLine{00205 \{}
...
\DoxyCodeLine{00213 }
\DoxyCodeLine{00214     std::vector<std::vector<int>> localB = calculateBLocal(localData, max, arraySize, myRank, processes, \&min, \&minX, \&minY);}
\DoxyCodeLine{00215 }
