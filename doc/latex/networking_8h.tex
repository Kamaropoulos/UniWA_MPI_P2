...
void {\bfseries calculate\+Displs\+Scounts} (int $\ast$\&, int $\ast$\&, int, int, int)
\item 
...
bool {\bfseries check\+Criteria} (std\+::vector$<$ std\+::vector$<$ int $>$$>$ local\+Data, int array\+Size, int my\+Rank, int processes, int $\ast$max\+Local)
\item 
...
\item 
\mbox{\Hypertarget{networking_8h_ac4a8fd6144df7a35c98878cd2b29735d}\label{networking_8h_ac4a8fd6144df7a35c98878cd2b29735d}} 
