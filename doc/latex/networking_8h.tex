\hypertarget{networking_8h}{}\section{src/networking.h File Reference}
\label{networking_8h}\index{src/networking.h@{src/networking.h}}
{\ttfamily \#include $<$vector$>$}\newline
Include dependency graph for networking.\+h\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=169pt]{networking_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{networking_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Functions}
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{networking_8h_a4f043b23867da30b825487b736565c9f}{Get\+M\+P\+I\+Params}} (int $\ast$processes\+Count, int $\ast$rank)
...
int \mbox{\hyperlink{networking_8h_a13ea20b290c58975e6f9ad5b419330cc}{\+\_\+line\+To\+Process}} (int line, int total\+Lines, int processes)
...
int \mbox{\hyperlink{networking_8h_a2b5f195179a5dab012c7eb63316c8909}{line\+To\+Process}} (int line, int total\+Lines, int processes)
...
std\+::vector$<$ int $>$ \mbox{\hyperlink{networking_8h_a899a3109ee6d901ce9e10411db36bd53}{process\+To\+Lines}} (int process, int total\+Lines, int processes)
...
int \mbox{\hyperlink{networking_8h_a1b2d1e5ad12dfa2377bd6e665324b6d2}{process\+To\+Lines\+Count}} (int process, int total\+Lines, int processes)
\begin{DoxyCompactList}\small\item\em The number of lines that will be assigned to a process. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{networking_8h_a63a302a1b5a18d9b3c42763b66fc948a}{broadcast\+Array\+Size}} (int $\ast$array\+Size)
\begin{DoxyCompactList}\small\item\em Method used to abstract the broadcasting of the array size. \end{DoxyCompactList}\item 
\mbox{\Hypertarget{networking_8h_ac04190fdac992ee045b8f473ca117453}\label{networking_8h_ac04190fdac992ee045b8f473ca117453}} 
void {\bfseries scatter\+Data} (std\+::vector$<$ std\+::vector$<$ int $>$$>$ data)
\item 
void \mbox{\hyperlink{networking_8h_aabb825fd2cbffbb991b3e7e41224024d}{calculate\+Displs\+Scounts}} (int $\ast$\&, int $\ast$\&, int, int, int)
...
std\+::vector$<$ std\+::vector$<$ int $>$ $>$ \mbox{\hyperlink{networking_8h_a3a44c57f314e8ae5a1c782ba82cfd8ad}{scatter\+Data}} (std\+::vector$<$ std\+::vector$<$ int $>$$>$ data, int array\+Size, int my\+Rank, int processes)
\begin{DoxyCompactList}\small\item\em Scatter the lines of matrix A to the running processes. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{networking_8h_aebdb84266a26d25a1e1309523febf4f0}{check\+Criteria}} (std\+::vector$<$ std\+::vector$<$ int $>$$>$ local\+Data, int array\+Size, int my\+Rank, int processes, int $\ast$max\+Local)
...
void \mbox{\hyperlink{networking_8h_aeb4e88c5e00d6166f5f35a59671f3667}{calculateB}} (std\+::vector$<$ std\+::vector$<$ int $>$$>$ local\+Data, int array\+Size, int max, int my\+Rank, int processes, int $\ast$min\+Local, int $\ast$min\+X\+Local, int $\ast$min\+Y\+Local)
...
void \mbox{\hyperlink{networking_8h_ad3bc02c1c672b6ae601f31c897f7af2f}{find\+Min}} (int min\+Local, int min\+X\+Local, int min\+Y\+Local, int $\ast$min)
...
Definition in file \mbox{\hyperlink{networking_8h_source}{networking.\+h}}.



\subsection{Function Documentation}
\mbox{\Hypertarget{networking_8h_a13ea20b290c58975e6f9ad5b419330cc}\label{networking_8h_a13ea20b290c58975e6f9ad5b419330cc}} 
\index{networking.h@{networking.h}!\_lineToProcess@{\_lineToProcess}}
\index{\_lineToProcess@{\_lineToProcess}!networking.h@{networking.h}}
...
\end{DoxyCode}
\mbox{\Hypertarget{networking_8h_a63a302a1b5a18d9b3c42763b66fc948a}\label{networking_8h_a63a302a1b5a18d9b3c42763b66fc948a}} 
\index{networking.h@{networking.h}!broadcastArraySize@{broadcastArraySize}}
\index{broadcastArraySize@{broadcastArraySize}!networking.h@{networking.h}}
...
\end{DoxyCode}
\mbox{\Hypertarget{networking_8h_aeb4e88c5e00d6166f5f35a59671f3667}\label{networking_8h_aeb4e88c5e00d6166f5f35a59671f3667}} 
\index{networking.h@{networking.h}!calculateB@{calculateB}}
\index{calculateB@{calculateB}!networking.h@{networking.h}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{networking_8h_aeb4e88c5e00d6166f5f35a59671f3667_cgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{networking_8h_aabb825fd2cbffbb991b3e7e41224024d}\label{networking_8h_aabb825fd2cbffbb991b3e7e41224024d}} 
\index{networking.h@{networking.h}!calculateDisplsScounts@{calculateDisplsScounts}}
\index{calculateDisplsScounts@{calculateDisplsScounts}!networking.h@{networking.h}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{networking_8h_aabb825fd2cbffbb991b3e7e41224024d_cgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{networking_8h_aebdb84266a26d25a1e1309523febf4f0}\label{networking_8h_aebdb84266a26d25a1e1309523febf4f0}} 
\index{networking.h@{networking.h}!checkCriteria@{checkCriteria}}
\index{checkCriteria@{checkCriteria}!networking.h@{networking.h}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{networking_8h_aebdb84266a26d25a1e1309523febf4f0_cgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{networking_8h_ad3bc02c1c672b6ae601f31c897f7af2f}\label{networking_8h_ad3bc02c1c672b6ae601f31c897f7af2f}} 
\index{networking.h@{networking.h}!findMin@{findMin}}
\index{findMin@{findMin}!networking.h@{networking.h}}
...
\end{DoxyCode}
\mbox{\Hypertarget{networking_8h_a4f043b23867da30b825487b736565c9f}\label{networking_8h_a4f043b23867da30b825487b736565c9f}} 
\index{networking.h@{networking.h}!GetMPIParams@{GetMPIParams}}
\index{GetMPIParams@{GetMPIParams}!networking.h@{networking.h}}
...
\end{DoxyCode}
\mbox{\Hypertarget{networking_8h_a2b5f195179a5dab012c7eb63316c8909}\label{networking_8h_a2b5f195179a5dab012c7eb63316c8909}} 
\index{networking.h@{networking.h}!lineToProcess@{lineToProcess}}
\index{lineToProcess@{lineToProcess}!networking.h@{networking.h}}
...
\begin{center}
\leavevmode
\includegraphics[width=279pt]{networking_8h_a2b5f195179a5dab012c7eb63316c8909_cgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{networking_8h_a899a3109ee6d901ce9e10411db36bd53}\label{networking_8h_a899a3109ee6d901ce9e10411db36bd53}} 
\index{networking.h@{networking.h}!processToLines@{processToLines}}
\index{processToLines@{processToLines}!networking.h@{networking.h}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{networking_8h_a899a3109ee6d901ce9e10411db36bd53_cgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{networking_8h_a1b2d1e5ad12dfa2377bd6e665324b6d2}\label{networking_8h_a1b2d1e5ad12dfa2377bd6e665324b6d2}} 
\index{networking.h@{networking.h}!processToLinesCount@{processToLinesCount}}
\index{processToLinesCount@{processToLinesCount}!networking.h@{networking.h}}
...
\begin{center}
\leavevmode
\includegraphics[width=312pt]{networking_8h_a1b2d1e5ad12dfa2377bd6e665324b6d2_cgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{networking_8h_a3a44c57f314e8ae5a1c782ba82cfd8ad}\label{networking_8h_a3a44c57f314e8ae5a1c782ba82cfd8ad}} 
\index{networking.h@{networking.h}!scatterData@{scatterData}}
\index{scatterData@{scatterData}!networking.h@{networking.h}}
