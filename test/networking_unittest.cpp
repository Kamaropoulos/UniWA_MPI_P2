...
{
    CHECK(_lineToProcess(0, 3, 4) == 0);
    CHECK(_lineToProcess(1, 3, 4) == 1);
    CHECK(_lineToProcess(2, 3, 4) == 2);
}

TEST_CASE("[Internal] Line to Process Assignments: 4 lines, 4 processes", "[ilineToProcess]")
{
    CHECK(_lineToProcess(0, 5, 4) == 0);
    CHECK(_lineToProcess(1, 5, 4) == 1);
    CHECK(_lineToProcess(2, 5, 4) == 2);
    CHECK(_lineToProcess(3, 5, 4) == 3);
    CHECK(_lineToProcess(4, 5, 4) == 0);
}

TEST_CASE("[Internal] Line to Process Assignments: 2 lines, 4 processes", "[ilineToProcess]")
{
    CHECK(_lineToProcess(0, 2, 4) == 0);
    CHECK(_lineToProcess(1, 2, 4) == 1);
}

TEST_CASE("[Internal] Line to Process Assignments: 1 line, 8 processes", "[ilineToProcess]")
{
    CHECK(_lineToProcess(0, 1, 8) == 0);
}
...
{
    CHECK(lineToProcess(0, 3, 4) == 0);
    CHECK(lineToProcess(1, 3, 4) == 1);
    CHECK(lineToProcess(2, 3, 4) == 2);
}
...
TEST_CASE("Line to Process Assignments: 5 lines, 4 processes", "[lineToProcess]")
{
    CHECK(lineToProcess(0, 5, 4) == 0);
    CHECK(lineToProcess(1, 5, 4) == 0);
    CHECK(lineToProcess(2, 5, 4) == 1);
    CHECK(lineToProcess(3, 5, 4) == 2);
    CHECK(lineToProcess(4, 5, 4) == 3);
}

TEST_CASE("Line to Process Assignments: 2 lines, 4 processes", "[lineToProcess]")
{
    CHECK(lineToProcess(0, 2, 4) == 0);
    CHECK(lineToProcess(1, 2, 4) == 1);
}

TEST_CASE("Line to Process Assignments: 1 line, 8 processes", "[lineToProcess]")
{
    CHECK(lineToProcess(0, 1, 8) == 0);
}
...
{
    CHECK(processToLines(0, 5, 4).size() == 2);
    CHECK(processToLines(1, 5, 4).size() == 1);
    CHECK(processToLines(2, 5, 4).size() == 1);
    CHECK(processToLines(3, 5, 4).size() == 1);

    CHECK(processToLines(0, 5, 4)[0] == 0);
    CHECK(processToLines(0, 5, 4)[1] == 1);

    CHECK(processToLines(1, 5, 4)[0] == 2);

    CHECK(processToLines(2, 5, 4)[0] == 3);
    
    CHECK(processToLines(3, 5, 4)[0] == 4);


    CHECK(processToLines(0, 2, 4).size() == 1);
